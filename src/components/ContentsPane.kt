...
internal fun line(x1: Number, y1: Number, x2: Number, y2: Number): Line2D.Double =
...
internal infix fun ClosedFloatingPointRange<Double>.overlaps(other: ClosedFloatingPointRange<Double>): Boolean
        = this.start in other || this.endInclusive in other || other.start in this || other.endInclusive in this
